...
public class OrderRavore extends AppCompatActivity {
    ...
    public void setupVariables(){
        if (LoginActivity.devStatus.equals("production")){
            sendOrderToFirebase = new Firebase(LoginActivity.useFirebase+"Orders");
            herokuToUse=productionHeroku;
            tokenToUse = productionTokenBT;}

        if (LoginActivity.devStatus.equals("sandbox")){
            sendOrderToFirebase = new Firebase(LoginActivity.useFirebase+"OrdersTest");
            herokuToUse=productionHeroku;
...
//
    ...
    void postNonceToServer(String nonce) {
        ...
        client.post(herokuToUse + "/checkout?payment_method_nonce=" + nonce + "&email=" + sendOrder.get("email") + "&amount=" + OrderRavore.totalPrice + "&devProd=" + LoginActivity.devStatus,
                new TextHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, String responseString) {
                        ...
                        Orders newOrder = new Orders(kandiCount, beadCount, subTotalPrice, shippingPrice, totalPrice, orderNumber, "Android", shippingAddress.getText().toString(), timeStamp, sendOrder.get("email"), fullName.getText().toString(), suiteApt.getText().toString(), "Processing", LoginActivity.android_id);
