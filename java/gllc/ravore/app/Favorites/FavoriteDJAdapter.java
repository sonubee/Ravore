...
public class FavoriteDJAdapter extends BaseAdapter implements CompoundButton.OnCheckedChangeListener {
    ...
    @Override
    public int getCount() {
        return MyApplication.allDjsArray.size();
    }

    @Override
    public Object getItem(int position) {

        return MyApplication.allDjsArray.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DJs dj = MyApplication.allDjsArray.get(position);
        ...
        holder.aSwitch.setChecked(MyApplication.favDjs.contains(dj.getDjName()));
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        newFavValue = new Firebase(MyApplication.useFirebase+"Users/Favorites/"+ MyApplication.android_id);
        newFavValue.child(MyApplication.allDjsArray.get(buttonView.getId()).getDjName()).setValue(isChecked);
